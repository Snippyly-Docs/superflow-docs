...
## 3) Import Superflow to the root level of your app
...
## 4) Initialize Superflow within your React.js app

Import `initSuperflow` from the NPM package and use it to initialize Superflow.

Be sure to execute the function within a `useEffect` hook.
